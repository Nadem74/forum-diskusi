...
<div class="card-header">
    <p style="text-align: left; font-size:30px; margin-top:25px">Forum Diskusi<br>
        <a href="/forum/create" type="submit" class="btn btn-primary text-white btn-md text-dark" style="border-radius:50px; margin-bottom:25px" >Mulai Diskusi</a>
    </p>
</div>
                ...
                <div class="card mb-2">
                    <div class="card-body">
                        <div class="media forum-item">
                            <a href="" data-toggle="collapse" data-target=".forum-content"><img src="images/{{$tanya->foto}}" class="mr-3 rounded-circle" width="50" alt="User" /></a>
                            ...
                            <div class="text-muted small text-center align-self-center">
                                Kategori :
                                {{-- @foreach ($tanya->kategori as $kat) --}}
                                <button style="margin-right: 10px" class="btn btn-primary btn-sm">{{$tanya->nama ? $tanya->nama:'No tags' }}</button>
                                {{-- @endforeach --}}
                            </div>
                                {{-- <div class="text-muted small text-center align-self-center">
                                Tags :
