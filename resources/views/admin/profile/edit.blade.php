    ...
    <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control  @error('umur') is-invalid @enderror" name="umur" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan umur" value="{{$user->profile->umur}}">
                        @error('umur')
                        <div class="invalid-feedback mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control  @error('phone') is-invalid @enderror" name="nomor_hp" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan nomor hp" value="{{$user->profile->nomor_hp}}">
                        @error('nomor_hp')
                        <div class="invalid-feedback mt-2">{{ $message }}</div>
                        @enderror
                    </div>
