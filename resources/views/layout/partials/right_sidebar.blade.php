...
<div class="card" style="background: #ffffff;  position: -webkit-sticky; position: sticky; top: 10px;">
    ...
    <h3 class="card-title">Who to follow</h3>
        ...
        <ul class="products-list product-list-in-card pl-3 pr-2">
            ...
            <div class="product-info">
                ...
                @if (is_null($if_null))
                    <a class="btn btn-primary btn-sm float-right mt-2 mr-3 py-2" href="/following/{{$users->id}}" style="border-radius:50px">Follow</a></span>
                @else
                    <a class="btn btn-primary btn-sm float-right mt-2 mr-3 py-2" href="/unfollow/{{$users->id}}" style="border-radius:50px">Following</a></span>
                @endif
